---
# Generated by `pnpm run skills:build` from skills/mobile/agents/mobile-architect.md. Do not edit here — edit the source and rebuild.
...
metadata:
  workpilot:
    pack: mobile
    version: 1.0.0
    content_sha256: 940d608c45700c7d1dc9210d956ecf23c0c325ed9e339a6cb77c8ad57e7a4eda
    targets:
      android: '>=8.0'
      ios: '>=16.0'
---
