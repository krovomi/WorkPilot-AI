---
# Generated by `pnpm run skills:build` from skills/mobile/agents/mobile-release-manager.md. Do not edit here — edit the source and rebuild.
...
metadata:
  workpilot:
    pack: mobile
    version: 1.0.0
    content_sha256: 7557ea0275571da64e7cc9f2fb79bfb61122e22e473155ad0f1b0bf940aeec36
    targets:
      android: '>=8.0'
      ios: '>=16.0'
---
