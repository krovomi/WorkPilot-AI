---
# Generated by `pnpm run skills:build` from skills/mobile/agents/android-engineer.md. Do not edit here — edit the source and rebuild.
...
metadata:
  workpilot:
    pack: mobile
    version: 1.0.0
    content_sha256: b27290fc5fe1f19893d94cb89fdb9ae7904d05902fb2f43e4cc0efb7526695e1
    targets:
      android: '>=8.0'
      ios: '>=16.0'
---
