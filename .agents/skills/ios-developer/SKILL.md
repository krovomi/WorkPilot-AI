---
# Generated by `pnpm run skills:build` from skills/mobile/ios-developer/SKILL.md. Do not edit here — edit the source and rebuild.
name: ios-developer
...
metadata:
  workpilot:
    ...
    targets:
      ios: '>=16.0'
    version: 1.0.0
    content_sha256: 730df6a461e7ce37d3db57bf385cde6e78af2c6bf5def31dc8e1ffacec5aa17d
---
