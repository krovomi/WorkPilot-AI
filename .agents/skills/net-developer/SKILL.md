---
# Generated by `pnpm run skills:build` from skills/dotnet/net-developer/SKILL.md. Do not edit here — edit the source and rebuild.
name: net-developer
...
metadata:
  workpilot:
    pack: dotnet
    version: 1.0.0
    content_sha256: 5a02491af54e8b7480c2a068d818710fa37b03d0ed4af67c9d4b9f9d980883c3
    targets:
      dotnet: '>=10.0'
---
