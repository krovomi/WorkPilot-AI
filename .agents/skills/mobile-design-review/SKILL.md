---
# Generated by `pnpm run skills:build` from skills/mobile/mobile-design-review/SKILL.md. Do not edit here — edit the source and rebuild.
...
metadata:
  workpilot:
    pack: mobile
    version: 1.0.0
    content_sha256: db3a175bdb33b9d81b5bf9ad275a2303a98d4a1ddbf65edf541ce7caae946509
    targets:
      android: '>=8.0'
      ios: '>=16.0'
---
