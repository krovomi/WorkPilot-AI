---
# Generated by `pnpm run skills:build` from skills/mobile/mobile-store-readiness/SKILL.md. Do not edit here — edit the source and rebuild.
...
metadata:
  workpilot:
    pack: mobile
    version: 1.0.0
    content_sha256: 49542383796b1242cb61e698c87dc705c9eeb5784c498eb5c48711ce5a083ebf
    targets:
      android: '>=8.0'
      ios: '>=16.0'
---
