---
# Generated by `pnpm run skills:build` from skills/mobile/cross-platform-mobile/SKILL.md. Do not edit here — edit the source and rebuild.
...
metadata:
  workpilot:
    pack: mobile
    version: 1.0.0
    content_sha256: 3a0709efd7583424f3fddb64c5ca3e566a75c1f9efbc944868b40962559cbac4
    targets:
      android: '>=8.0'
      ios: '>=16.0'
---
