...
export interface TaskAPI {
	...
	getWorktreeStatus: (
		taskId: string,
	) => Promise<IPCResult<import("../../shared/types").WorktreeStatus>>;
	getWorktreeDiff: (
		taskId: string,
	...
	) => Promise<IPCResult<import("../../shared/types").WorktreeMergeResult>>;
	...
	) => Promise<IPCResult<import("../../shared/types").WorktreeSyncResult>>;
	clearStagedState: (
		taskId: string,
