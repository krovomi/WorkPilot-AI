...
import { ExternalLink, Globe, Terminal, X } from "lucide-react";
					...
					{formData.type === "http" && (
						<>
							...
							<div className="space-y-2">
								...
								>
									<span
										className={`transition-transform ${showAdvancedHeaders ? "rotate-90" : ""}`}
									>
										▶
									</span>
								...
								{showAdvancedHeaders && (
									<div className="pl-4 space-y-2">
										...
										{Object.entries(formData.headers || {}).some(
