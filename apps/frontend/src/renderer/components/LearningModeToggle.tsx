...
const EXPLANATION_LEVELS: Array<{
...
}> = [
	{
		...
		label: "Débutant",
		description:
			"Explications très détaillées, sans présupposé de connaissances",
	},
	{
		value: "intermediate",
		label: "Intermédiaire",
...
export function LearningModeToggle({
	...
	const currentLevel = EXPLANATION_LEVELS.find(
		(l) => l.value === currentConfig.explanationLevel,
	);
