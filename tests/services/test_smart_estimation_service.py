...
class TestSmartEstimationService:
    ...
    def service(self):
        ...
        with patch(
            "services.smart_estimation_service.get_current_model_info",
            return_value=None,
        ):
    ...
    def test_extract_file_patterns(self, service):
        ...
        with patch.object(
            ...
            return_value=["component", "service", "controller"],
        ):
    ...
    def test_identify_complexity_indicators(self, service):
        ...
        complex_desc = (
            "Create a scalable real-time distributed system with async operations"
        )
        ...
        with patch.object(
            service, "_identify_complexity_indicators", return_value=mock_indicators
        ):
    ...
    def test_infer_complexity_from_metrics(self, service):
        ...
        with patch.object(service, "_infer_complexity_from_metrics", return_value=8):
            complexity = service._infer_complexity_from_metrics(
    ...
    def test_calculate_confidence_level(self, service):
        ...
        with patch.object(service, "_calculate_confidence_level", return_value=0.8):
            confidence = service._calculate_confidence_level(
                similar_tasks_high, factors
            )
        ...
        with patch.object(
            ...
            with patch(
                ...
                result = service.analyze_task_description(
                    "Add user authentication with JWT", "project-123"
                )
    ...
    def test_analyze_task_description_no_db(self, service):
        ...
        with patch.object(
            ...
            with patch(
                ...
                result = service.analyze_task_description(
                    "Add user authentication", "any-project"
                )
    ...
    def test_generate_recommendations(self, service):
        ...
        similar_tasks = [{"status": "failed"}, {"status": "complete"}]
        ...
        with patch.object(
            service, "_generate_recommendations", return_value=mock_recommendations
        ):
            recommendations = service._generate_recommendations(
                factors, 10, similar_tasks
            )
...
class TestSmartEstimationIntegration:
    ...
    def test_full_estimation_flow(self, mock_get_db):
        ...
        with patch.object(
            ...
            # Run estimation
            result = service.analyze_task_description(
                "Implement user authentication with OAuth2", "project-123"
            )
