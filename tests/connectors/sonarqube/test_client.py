...
SonarQubeClient = client_module.SonarQubeClient
SonarQubeAPIError = exceptions_module.SonarQubeAPIError
SonarQubeAuthenticationError = exceptions_module.SonarQubeAuthenticationError
SonarQubeConfigurationError = exceptions_module.SonarQubeConfigurationError
SonarQubeProjectNotFoundError = exceptions_module.SonarQubeProjectNotFoundError
