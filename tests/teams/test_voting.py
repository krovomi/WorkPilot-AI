...
class TestVotingSystem:
    ...
    def test_security_veto_blocks_decision(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            result = voting.conduct_vote(
                votes, DebateStrategy.WEIGHTED_VOTE, "Feature X"
            )
    ...
    def test_weighted_vote_with_architect_majority(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            result = voting.conduct_vote(
                votes, DebateStrategy.WEIGHTED_VOTE, "Approach"
            )
    ...
    def test_veto_without_rights_ignored(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            votes = [
                ...
                Vote(
                    "developer", VoteChoice.VETO, "I veto!", weight=3, can_veto=False
                ),  # No rights!
    ...
    def test_vote_result_saves_to_disk(self):
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            result = voting.conduct_vote(
                votes, DebateStrategy.WEIGHTED_VOTE, "test_topic"
            )
