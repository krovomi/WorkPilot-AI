...
def run_test(script_name, description):
    ...
    try:
        result = subprocess.run([sys.executable, script_name], timeout=300)
...
╚════════════════════════════════════════════════════════════════════════════╝
    ...
    results.append(
        (
            "Syntaxe Python",
            run_test("check_syntax.py", "Test 1: Vérification syntaxe Python"),
        )
    )
    ...
    results.append(
        (
            "Auto-Fix Simplified",
            run_test(
                "test_auto_fix_simplified.py", "Test 2: Tests auto-fix simplifiés"
            ),
        )
    )
    ...
    results.append(
        (
            "Validation Imports",
            run_test("test_validation.py", "Test 3: Validation des imports"),
        )
    )
