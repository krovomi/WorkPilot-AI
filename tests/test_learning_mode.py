...
def test_learning_mode_initialization():
    ...
    config = LearningModeConfig(
        enabled=True, explanation_level=ExplanationLevel.INTERMEDIATE
    )
...
def test_session_summary():
    ...
    learning_mode.explain_tool_use("Read", {"file": "test.py"}, "Testing", "Result")
    learning_mode.explain_decision("Use FastAPI", "Modern and fast", [])
