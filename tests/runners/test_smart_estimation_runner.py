...
class TestSmartEstimationRunner:
    ...
    def test_run_estimation_success(self, tmp_path, runner, mock_estimation_service):
        ...
        event_calls = [
            call for call in print_calls if call.startswith("SMART_ESTIMATION_EVENT:")
        ]
    ...
    def test_run_estimation_unknown_project_path(self, tmp_path, runner):
        ...
        print_calls = [call[0][0] for call in mock_print.call_args_list]
        error_calls = [
            call for call in print_calls if call.startswith("SMART_ESTIMATION_ERROR:")
        ]
...
class TestSmartEstimationRunnerCLI:
    ...
    def test_main_function_success(self, mock_parser, mock_runner_class):
        ...
        print_calls = [call[0][0] for call in mock_print.call_args_list]
        result_calls = [
            call for call in print_calls if call.startswith("SMART_ESTIMATION_RESULT:")
        ]
    ...
    def test_argument_parser_setup(self):
        ...
        with patch(
            "runners.smart_estimation_runner.SmartEstimationRunner"
...
class TestSmartEstimationRunnerIntegration:
    ...
    def test_full_runner_integration(self, mock_get_service, tmp_path):
        ...
        events = [
            json.loads(call.replace("SMART_ESTIMATION_EVENT:", ""))
